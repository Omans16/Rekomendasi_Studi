...
@push('scripts')
    <script src="{{ asset('js/admin/input-siswa.js') }}" defer></script>
@endpush

@section('content')

<div class="admin-input-page">
        ...
        <div class="two-col">
            ...
            <div>
                <div class="card card-summary">
                    ...
                    <div class="card-sub">
                        Fitur agregat ini digunakan sebagai input tambahan model Random Forest untuk menangkap konsistensi akademik siswa. Dihitung otomatis dari 6 nilai: rata_pai, rata_ppkn, rata_ind, rata_mtk, rata_ing, dan UKK.
                    </div>
                </div>
